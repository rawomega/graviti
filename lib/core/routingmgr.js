...
var self = module.exports = {
	...
	getNextHop : function(id) {
		...
		var leafsetMinMax = ringutil.getHighestAndLowestIds(leafset);
		if (leafsetMinMax && leafsetMinMax.highest)
			fallbackRoutingCandidates[leafsetMinMax.highest] = leafset[leafsetMinMax.highest];
		if (leafsetMinMax && leafsetMinMax.lowest)
			fallbackRoutingCandidates[leafsetMinMax.lowest] = leafset[leafsetMinMax.lowest];
