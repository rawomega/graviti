...
var self = module.exports = {
	...
	_handleBootstrapRequest : function(msg, msginfo, forwarding) {
		...
		leafset.updateWithProvisional(msg.content.id, bootstrapSourceAddr + ':' + bootstrapSourcePort);
	...
	_handleBootstrapResponse : function(msg, msginfo) {
		...
		leafset.updateWithKnownGood(msg.content.id, msginfo.sender_addr + ':' + msginfo.sender_port);
