...
var options = [ {
	...
	"short" : 'l',
	'long' : 'logconf',
	description : 'Logging configuration file to use and watch',
	value : true
}];
...
var logConf = opts.get('logconf');

// init logging
logmgr.start('etc/logconf.json');

// these requires need to sit after logging init
