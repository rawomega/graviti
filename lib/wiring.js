...
var bootstrapMgr = new require('overlay/pastry/bootstrapmgr').BootstrapMgr(overlayCallback, pnsRunner);
var heartbeater = new require('overlay/pastry/heartbeater').Heartbeater(overlayCallback, leafset, routingtable);
var routingMgr = new require('overlay/pastry/routingmgr').RoutingMgr(leafset, routingtable);
