...
BootstrapMgr = function(messagemgr, leafset, routingtable, heartbeater, pnsrunner) {	
...
BootstrapMgr.prototype.start = function(bootstraps, bootstrapCompletedCallback) {
	...
	this.messagemgr.on('graviti-message-forwarding', this._handleForwardingGravitiMessage.bind(this));
...
BootstrapMgr.prototype._handleReceivedGravitiMessage = function(msg, msginfo) {
...
BootstrapMgr.prototype._handleForwardingGravitiMessage = function(msg, msginfo) {
