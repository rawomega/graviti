...
RoutingTable.prototype.peer = function(id) {
	var commonPrefix = ringutil.getCommonPrefixLength(node.nodeId, id);
...
RoutingTable.prototype.getSharedRow = function(id) {
	var commonPrefixLength = ringutil.getCommonPrefixLength(node.nodeId, id);
	var res = {};
...
RoutingTable.prototype.findBetterRoutingHop = function(sourceId, destId) {
	var self = this;
	var commonPrefixLengthWithSource = ringutil.getCommonPrefixLength(node.nodeId, sourceId);
	var commonPrefixLengthWithDest = ringutil.getCommonPrefixLength(node.nodeId, destId);
