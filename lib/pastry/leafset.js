...
Leafset.prototype.updateWithKnownGood = function(a, b) {
	...
	self._update(a,b, function(id, addrPort) {
		...
		if (self._leafset[id]) {
			...
			var sorted = ringutil.sortByIncreasingDistance(self.nodeId, Object.keys(self._leafset).concat([id]));
...
Leafset.prototype.getRoutingHop = function(id) {
	var leafsetIds = Object.keys(this._leafset).concat([this.nodeId]);
...
Leafset.prototype.isWithinLeafsetRange = function(id) {
	...
	var sorted = ringutil.sortByIncreasingDistance(this.nodeId, Object.keys(this._leafset).concat([id]));
...
Leafset.prototype.isThisNodeNearestTo = function(id) {
	return ringutil.amINearest(id, this.nodeId, Object.keys(this._leafset));
};
...
Leafset.prototype.getEdgePeers = function() {
	...
	var sorted = ringutil.sortByIncreasingDistance(this.nodeId, Object.keys(this._leafset));
