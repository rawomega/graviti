...
var self = module.exports = {
	...
	getNextHop : function(id) {
		...
		if (rowForDigit) {
			...
			for (var curr in rowForDigit) {
				fallbackRoutingCandidateIds.push(rowForDigit[curr]);
			}
		}
		...
		if (rowForPreviousDigit) {
			...
			for (var curr in rowForPreviousDigit) {
				fallbackRoutingCandidateIds.push(rowForPreviousDigit[curr]);
			}
		}
