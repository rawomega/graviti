...
var self = module.exports = {
	...
	TestNode : function(idx, conf) {
		...
		return {
			...
			waitUntilEqual : function(expected, func, callback, errCallback, waitedSoFar) {
				console.log('ddddddddddd ' + waitedSoFar);
				if (waitedSoFar !== undefined && (waitedSoFar > conf.wait_timeout_msec)) {
					console.log('\nn\lllllln\n\ ');
					errCallback("Timed out");
					return;
				}
				...
				var tryAgain = function() {
					setTimeout(function() {
						_this.waitUntilEqual(expected, func, callback, errCallback,
