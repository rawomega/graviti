...
function Transport(udptran, tcptran, messageparser) {
...
Transport.prototype.router = undefined;
...
Transport.prototype._processMessage = function(msg, msginfo) {
	...
	if (isForThisNode) {
		...
		this.sendData(msginfo.next_hop_port, msginfo.next_hop_addr, msg);
...
Transport.prototype.sendData = function(port, host, msg) {
...
Transport.prototype.receiveData = function(data, remoteAddress, inProgressState) {		
