...
exports.createStack = function(port, bindAddr, router) {
	var udptran = new UdpTran(port, bindAddr);
	var tcptran = new TcpTran(port, bindAddr);
	return new TransportStack(udptran, tcptran, router);
};

function TransportStack(udptran, tcptran, router) {
...
TransportStack.prototype.start = function() {
	var self = this;
...
TransportStack.prototype.sendMessage = function(port, host, msg) {
